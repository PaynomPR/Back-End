...
def RAtxt(ac,resbmited,resbmited_code):
    ...
    return "RA"+ac.employer_insurance_number.replace("-", "")[:9]+ac.identidad_ssa[:8]+add_to_right(text,4," ")+add_to_right(text,5," ")+str(resbmited)+str(resbmited_code)+"99"+ac.company.ljust(57)+ac.physical_address[:22].ljust(22)+ac.address[:22].ljust(22)+COUNTRY[int(ac.physical_country)][:22].ljust(22)+ac.physical_state+ac.physical_zip_code+add_to_right(text,4," ")+add_to_right(text,5," ")+add_to_right(text,23," ")+add_to_right(text,15," ")+add_to_right(text,2," ")+(ac.name+" "+ac.middle_name+" "+ac.first_last_name).ljust(57)+ac.physical_address[:22].ljust(22)+ac.address[:22].ljust(22)+COUNTRY[int(ac.physical_country)][:22].ljust(22)+ac.physical_state+ac.physical_zip_code+add_to_right(text,4," ")+add_to_right(text,5," ")+add_to_right(text,23," ")+add_to_right(text,15," ")+add_to_right(text,2," ")+((ac.name+" "+ac.first_last_name)).ljust(27)+ac.phone.replace("-","").ljust(15)+add_to_right(text,5," ")+add_to_right(text,3," ")+ac.email.ljust(40)+add_to_right(text,3," ")+add_to_right(text,10," ")+add_to_right(text,1," ")+"A"+add_to_right(text,12," ")
