...
def RAtxt(ac,resbmited,resbmited_code):
    ...
    return "RA"+ac.employer_insurance_number.replace("-", "")[:9]+ac.identidad_ssa[:8]+add_to_right(text,4," ")+add_to_right(text,5," ")+str(resbmited)+str(resbmited_code)+"99"+ac.company.ljust(57)+ac.physical_address[:22].ljust(22)+ac.address[:22].ljust(22)+COUNTRY[int(ac.physical_country)-2][:22].ljust(22)+ac.physical_state+ac.physical_zip_code+add_to_right(text,4," ")+add_to_right(text,5," ")+add_to_right(text,23," ")+add_to_right(text,15," ")+add_to_right(text,2," ")+(ac.name+" "+ac.middle_name+" "+ac.first_last_name).ljust(57)+ac.physical_address[:22].ljust(22)+ac.address[:22].ljust(22)+COUNTRY[int(ac.physical_country)-2][:22].ljust(22)+ac.physical_state+ac.physical_zip_code+add_to_right(text,4," ")+add_to_right(text,5," ")+add_to_right(text,23," ")+add_to_right(text,15," ")+add_to_right(text,2," ")+((ac.name+" "+ac.first_last_name)).ljust(27)+ac.phone.replace("-","").ljust(15)+add_to_right(text,5," ")+add_to_right(text,3," ")+ac.email.ljust(40)+add_to_right(text,3," ")+add_to_right(text,10," ")+add_to_right(text,1," ")+"A"+add_to_right(text,12," ")
...
def RStxt(employer,company,total_6,total_19,total_16,total_12,birthday):
    ...
    return "RS"+add_to_right(text,2,"0")+add_to_right(text,5,"0")+employer.social_security_number.replace("-","")[:9]+employer.first_name.ljust(15)+employer.middle_name.ljust(15)+(employer.last_name+" "+employer.mother_last_name).ljust(20)+add_to_right(text,4," ")+employer.address[:22].ljust(22)+employer.address[:22].ljust(22)+COUNTRY[int(employer.address_country)-2][:22].ljust(22)+employer.address_state.ljust(2)+employer.address_number.ljust(5)+add_to_right(text,4," ")+add_to_right(text,1," ")+add_to_right(text,1," ")+add_to_right(text,1," ")+add_to_right(text,40," ")+add_to_right(text,1," ")+add_to_right(text,1," ")+total_6+total_19+add_to_right(text,15,"0")+add_to_right(text,11,"0")+add_to_right(text,2," ")+add_to_right(text,29," ")+add_to_right(text,34,"0")+add_to_right(text,1," ")+add_to_right(text,22,"0")+add_to_right(text,1," ")+add_to_right(text,9,"0")+add_to_right(text,6,"0")+add_to_right(text,1," ")+add_to_right(text,8,"0")+company.w2_first_control[:9]+add_to_right(text,11,"0")+add_to_right(text,11,"0")+total_12+add_to_right(text,6," ")+add_to_right(text,11,"0")+add_to_right(text,11,"0")+add_to_right(text,5,"0")+total_16+code+add_to_right(text,2," ")+add_to_right(text,1," ")+add_to_right(text,2," ")+add_to_right(text,23," ")+add_to_right(text,15," ")+add_to_right(text,2," ")+add_to_right(text,11,"0")+add_to_right(text,1," ")+add_to_right(text,1," ")+birthday.strftime("%Y%m%d")+add_to_right(text,4," ")
...
def RVtxt(count,company,acum_total_16,acum_total_6):
    ...
    return "RV"+company.contact_number.replace("-","").ljust(10)+add_to_right(text,20," ")+add_to_right(text,15,"0")+add_to_right(text,15,"0")+acum_total_16+add_to_right(text,15,"0")+acum_total_6+add_to_right(text,15,"0")+add_to_right(text,15,"0")+add_to_right(text,375," ")
