...
def RAtxt(ac,resbmited,resbmited_code):
    ...
    return "RA"+ac.employer_insurance_number.replace("-", "")[:9]+ac.identidad_ssa[:8]+add_to_right(text,4," ")+add_to_right(text,5," ")+str(resbmited)+str(resbmited_code)+"99"+ac.company.ljust(57)+ac.physical_address.ljust(22)+ac.address.ljust(22)+COUNTRY[round(ac.physical_country)-1].ljust(22)+ac.physical_state+ac.physical_zip_code+add_to_right(text,4," ")+add_to_right(text,5," ")+add_to_right(text,23," ")+add_to_right(text,15," ")+add_to_right(text,2," ")+(ac.name+" "+ac.middle_name+" "+ac.first_last_name).ljust(57)+ac.company.ljust(57)+ac.physical_address.ljust(22)+ac.address.ljust(22)+COUNTRY[round(ac.physical_country)-1].ljust(22)+ac.physical_state+ac.physical_zip_code+add_to_right(text,4," ")+add_to_right(text,5," ")+add_to_right(text,23," ")+add_to_right(text,15," ")+add_to_right(text,2," ")+(ac.name+" "+ac.first_last_name).ljust(27)+ac.phone.replace("-","").ljust(15)+add_to_right(text,5," ")+add_to_right(text,3," ")+ac.email.ljust(40)+add_to_right(text,3," ")+add_to_right(text,10," ")+add_to_right(text,1," ")+"A"+add_to_right(text,12," ")
...
def REtxt(year,company):
    ...
    if (company.payer == "4"):
        payer = "H"
    return "RE"+str(year)+add_to_right(text,1," ")+company.number_patronal.replace("-","")[:9]+add_to_right(text,9," ")+"0"+add_to_right(text,4," ")+add_to_right(text,9," ")+company.name.ljust(57)+company.physical_address.ljust(22)+company.postal_address.ljust(22)+COUNTRY[round(company.country_physical_address)-1].ljust(22)+company.state_physical_address.ljust(2)+company.zipcode_physical_address.ljust(5)+add_to_right(text,4," ")+add_to_right(text,5," ")+add_to_right(text,23," ")+add_to_right(text,15," ")+add_to_right(text,2," ")+payer+"P"+"0"+company.contact.ljust(27)+company.contact_number.replace("-","").ljust(15)+add_to_right(text,5," ")+add_to_right(text,10," ")+company.email.ljust(40)+add_to_right(text,194," ")
