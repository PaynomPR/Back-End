...
def queryFormUnemployment (company_id, year, period):
    ...
    data = {
        ...
        'text_total_wages_a': str(roundedAmount(totalAmount)),
        'text_total_wages_b': str(roundedAmount(totalAmount)),
        'text_wages_contributions_a': str(roundedAmount(totalAmount_taxeable_a)),
        'text_wages_contributions_b': str(roundedAmount(totalAmount_taxeable_b)),
        'text_value_porcentage_a': str(company.unemployment_percentage),
        'text_value_porcentage_b': str(roundedAmount(disabled_percent+ float(company.driver_code))),
