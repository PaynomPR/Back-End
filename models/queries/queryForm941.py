...
def queryForm941(company_id, year, period):
    ...
    data = {
        ...
        'topmostSubform[0]Page1[0]EntityArea[0]f1_6[0]':  COUNTRY[int(company.country_postal_address)],
        ...
        'topmostSubform[0]Page3[0]Ciudad_ReadOrder[0]f3_36[0]': COUNTRY[int(account.country)],
